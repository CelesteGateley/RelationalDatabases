...
<?php include_once '../controllers/SessionController.php'; verifySession(); ?>

<?php if (!$_SESSION['logged_in']) { echo "<script type='text/javascript'>location.href = '../public/index.php';</script>"; } ?>
<p>
